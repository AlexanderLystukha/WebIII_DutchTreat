...
namespace DutchTreat.Data.Repositories.Helpers
{
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        public RepositoryProvider(ILoggerFactory loggerFactory, ApplicationDbContext dbContext) 
        {
        ...
        {
            return GetRepository<IDutchRepository<T>>(_repositoryFactories.GetRepositoryFactoryForEntityType<T>());
        }
